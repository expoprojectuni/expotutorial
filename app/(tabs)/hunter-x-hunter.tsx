...
const ACCENT = "#7CFF6B";
const ACCENT_SOFT = "#7CFF6B22";

const PERSONAJES_DISPONIBLES = [
  "Biscuit Krueger", "Feitan", "Machi", "Uvogin", "Pakunoda",
  "Kite", "Komugi", "Youpi", "Pouf", "Ging Freecss"
];
    ...
    <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent}>
      <View style={styles.header}>
        <View style={styles.headerTopRow}>
          <Text style={styles.eyebrow}>{"// serie 02"}</Text>
          <LogoutButton />
        </View>
        <Text style={styles.headerTitle}>hunter x hunter</Text>
        <View style={styles.accentLine} />
        <Text style={styles.headerSubtitle}>la aventura comienza</Text>
      </View>
      ...
      <View style={styles.container}>
        <View style={styles.inputContainer}>
          ...
          <TextInput
            ...
            placeholder="ej: biscuit krueger, feitan, kite..."
